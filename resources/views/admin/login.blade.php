...
<div class="max-w-md mx-auto">
    <div class="card rounded-xl p-8">
        <div class="text-center mb-8">
            <h1 class=" text-1xl font-semibold" style="color: var(--text-primary);"><b>ADMIN LOGIN</b></h1>
            <p class="mt-2" style="color: var(--text-secondary);">Akses khusus untuk admin/pemilik website</p>
            <div class="mt-3 p-3 rounded-lg" style="background-color: var(--bg-primary); border: 1px solid var(--border-color);">
                <p class="text-sm" style="color: var(--text-secondary);">
                    <strong style="color: var(--text-primary);">Area Terbatas:<br>
                    </strong>Halaman ini hanya untuk mengelola konten blog, Hanya admin yang memiliki akses ke panel ini.
                </p>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('admin.login.submit') }}" class="space-y-6">
            ...
            <div class="flex items-center">
                ...
                <label for="remember" class="ml-2 block text-sm" style="color: var(--text-secondary);">Remember me</label>
            </div>

            <div>
                <button type="submit" class="w-full btn-primary py-3 font-medium transition-all duration-200 transform hover:scale-105">
                    Sign In
                </button>
            </div>
        </form>
        ...
        <div class="mt-6 text-center">
            <a href="{{ route('home') }}" class="text-sm transition-colors"
