    ...
    <div class="max-w-md mx-auto">
        <div class="card rounded-xl p-8">
            <div class="text-center mb-8">
                ...
                <div class="mt-3 p-3 rounded-lg"
                    ...
                    <p class="text-sm" style="color: var(--text-secondary);">
                        ...
                        </strong>Halaman ini hanya untuk mengelola konten blog, Hanya admin yang memiliki akses ke panel
                        ini.
                    </p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('admin.login.submit') }}" class="space-y-6">
                @csrf
                <div>
                    <label for="email" class="block text-sm font-medium mb-2" style="color: var(--text-primary);">Alamat
                        Email</label>
                ...
                <div>
                    <label for="password" class="block text-sm font-medium mb-2" style="color: var(--text-primary);">Kata
                        Sandi</label>
                ...
                <div class="flex items-center">
                    ...
                    <label for="remember" class="ml-2 block text-sm" style="color: var(--text-secondary);">Ingat
                        saya</label>
                </div>
