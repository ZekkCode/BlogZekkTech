...
<div class="max-w-md mx-auto">
    <div class="card rounded-xl p-8">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-semibold" style="color: var(--text-primary);">Admin Login</h1>
            <p class="mt-2" style="color: var(--text-secondary);">Sign in to access the admin panel</p>
        </div>
