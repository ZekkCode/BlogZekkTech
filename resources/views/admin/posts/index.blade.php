...
@section('content')
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .admin-table td .flex a,
            .admin-table td .flex button {
                padding: 0.5rem;
                border-radius: 0.75rem; /* Changed from 0.25rem to 0.75rem */
        ...
        @media (max-width: 480px) {
            ...
            /* Categories styling for small mobile */
            .category-scroll {
                max-height: 2rem;
                display: flex !important;
                flex-wrap: wrap !important;
                ...
                <tbody>
                    @foreach($posts as $post)
                        <tr style="border-bottom: 1px solid var(--border-color);"
                            ...
                            <td class="px-6 py-4" data-label="Title & Categories">
                            ...
                            <td class="px-6 py-4" data-label="Published">
                            ...
                            <td class="px-6 py-4" data-label="Actions">
                                <div class="flex space-x-2">
                                    <a href="{{ route('blog.show', $post->slug) }}" class="transition-colors" target="_blank"
                                        ...
                                        onmouseout="this.style.opacity='1'" title="View Post">
                                    ...
                                    <form action="{{ route('admin.posts.destroy', $post->id) }}" method="POST"
                                        ...
                                        <button type="button" class="text-red-400 hover:text-red-300"
                                            onclick="customConfirm('Are you sure you want to delete this post? This action cannot be undone.', function(result) { if(result) document.getElementById('deleteForm{{ $post->id }}').submit(); })"
                                            title="Delete Post">
