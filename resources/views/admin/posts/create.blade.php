...
@section('content')
    ...
    <div class="max-w-4xl mx-auto">
        <div class="card rounded-lg p-4 sm:p-6 mb-8">
            <h1 class="text-xl sm:text-2xl font-bold mb-6" style="color: var(--text-primary);">Create New Post</h1>
            ...
            <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="body" id="body" rows="15"
                        ...
                        style="background-color: var(--bg-primary); border: 1px solid var(--border-color); color: var(--text-primary);"
                        required></textarea>
                    <p class="text-sm mt-2" style="color: var(--text-secondary);">You can use Markdown to format your post.
                    </p>
                </div>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-end mt-6 gap-2 sm:gap-0">
                    ...
                    <button type="submit"
                        class="btn-primary font-bold py-2 px-4 rounded-xl w-full sm:w-auto order-1 sm:order-2">Create
                        Post</button>
                </div>
            </form>
        </div>
        ...
        <div class="card rounded-lg p-4 sm:p-6">
            <h2 class="text-lg sm:text-xl font-bold mb-4" style="color: var(--text-primary);">Markdown Guide</h2>
