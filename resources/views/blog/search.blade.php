        ...
        <form action="{{ route('search') }}" method="GET" class="mb-6">
            <div class="relative max-w-md">
                <input type="text"
                    ...
                    onfocus="this.style.ringColor='var(--accent-color)'"
                    onblur="this.style.ringColor=''">
    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="w-full lg:w-2/3">
            ...
            <div class="card rounded-xl p-12 text-center">
                <div class="mb-4">
                    <svg class="mx-auto h-16 w-16" style="color: var(--text-secondary);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                    </svg>
                </div>
                <h3 class="text-xl font-bold mb-2" style="color: var(--text-primary);">No results found</h3>
            ...
            <div class="card rounded-xl p-12 text-center">
                ...
                <h3 class="text-xl font-bold mb-2" style="color: var(--text-primary);">Search Articles</h3>
                <p style="color: var(--text-secondary);">
                    Enter a search term to find articles on our blog.
                </p>
            </div>
            @endif
        </div>
        ...
        <div class="w-full lg:w-1/3">
            <div class="space-y-8">
                ...
                <div class="card rounded-xl p-6">
                    <h3 class="text-lg font-bold mb-4" style="color: var(--text-primary);">Categories</h3>
                    <div class="space-y-2">
                        ...
                        <a href="{{ route('blog.category', $category->slug) }}"
                            ...
                            <span class="text-sm bg-gray-500 text-white px-2 py-1 rounded-full">{{ $category->posts_count }}</span>
                        </a>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="card rounded-xl p-6">
                    <h3 class="text-lg font-bold mb-4" style="color: var(--text-primary);">Latest Posts</h3>
                    <div class="space-y-4">
