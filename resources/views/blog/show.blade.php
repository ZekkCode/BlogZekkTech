        ...
        <div class="lg:col-span-2 main-content">
            ...
            <div class="mb-6 sm:mb-8">
                <img src="{{ asset('storage/' . $post->image) }}" alt="{{ $post->title }}"
                    ...
                    style="max-height: 400px; aspect-ratio: 1.91/1;"
                    loading="lazy">
            </div>
            @endif
                ...
                <div class="space-y-1">
                    ...
                    <div class="related-post-item">
                        <div class="related-post-image">
                            ...
                            @else
                            <div class="w-full h-full flex items-center justify-center rounded-lg" style="background-color: var(--border-color);">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" style="color: var(--text-secondary);" fill="none" viewBox="0 0 24 24" stroke="currentColor">
